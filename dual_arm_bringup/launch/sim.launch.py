"""Top-level mock-hardware entry point.

This is the recommended simulation launch. It always starts the shared robot
base stack and RViz, then starts exactly one control mode:
  mode:=moveit -> MoveGroup
  mode:=servo  -> two MoveIt Servo nodes

Use this file instead of launching control_base.launch.py, move_group.launch.py,
rviz.launch.py, or servo.launch.py by hand for normal mock-hardware testing.
"""
...
def generate_launch_description():
    ...
    enable_rviz_servo_marker_arg = DeclareLaunchArgument(
        ...
        default_value="true",
        description="Servo 模式下是否启用 RViz 双臂交互 marker",
    )
